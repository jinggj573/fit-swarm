...
@Slf4j
public class FitAuthenticationFailureEventHandler implements AuthenticationFailureHandler {
    ...
    private void sendErrorResponse(HttpServletRequest request, HttpServletResponse response,
        ...
        this.errorHttpResponseConverter.write(CommonResult.failed(errorMessage), MediaType.APPLICATION_JSON, httpResponse);
    }
