package com.support.fit.auth.support.core;
...
public class FitDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public FitDaoAuthenticationProvider() {
