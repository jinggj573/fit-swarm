...
public class FitResourceServerAutoConfiguration {
     ...
     */
    @Bean
    public FitBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
        return new FitBearerTokenExtractor(urlProperties);
    }
    ...
    public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
        return new FitCustomOpaqueTokenIntrospector(authorizationService);
    }
    ...
    public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
        return new FitOAuthRequestInterceptor(tokenResolver);
    }
}
