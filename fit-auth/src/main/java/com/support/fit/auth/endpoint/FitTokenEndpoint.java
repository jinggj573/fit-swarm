package com.support.fit.auth.endpoint;
...
import com.support.fit.common.security.util.OAuth2EndpointUtils;
import com.support.fit.common.security.util.OAuth2ErrorCodesExpand;
import com.support.fit.common.security.util.OAuthClientException;
import com.support.fit.mbg.dto.TokenVo;
...
public class FitTokenEndpoint {

    private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

    private final AuthenticationFailureHandler authenticationFailureHandler = new FitAuthenticationFailureEventHandler();
